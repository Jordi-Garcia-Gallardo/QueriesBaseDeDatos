...
CREATE TABLE IF NOT EXISTS `optica`.`ulleres` (
  ...
  CONSTRAINT `fk_Glasses_Marcas1`
    FOREIGN KEY (`Marcas_Marcas_ID` , `Marcas_Nombre_Marcas`)
    REFERENCES `optica`.`marca` (`Marca_ID` , `Nombre_Marca`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
...
INSERT INTO `optica`.`client` (`Client_id`, `Nom`, `Adreça`, `Telefon`, `Email`, `Data_Registre`, `Recomanació_De`) VALUES (2, 'JOAN', 'Carrer Rosello 85', 656249757, 'joan@gmail.com', '2021-02-02', 'JORDI');
INSERT INTO `optica`.`client` (`Client_id`, `Nom`, `Adreça`, `Telefon`, `Email`, `Data_Registre`, `Recomanació_De`) VALUES (3, 'CARLES', 'Carrer Corsega 53', 600695321, 'carles@gmail.com', '2021-02-02', 'JORDI');
...
INSERT INTO `optica`.`marca` (`Marca_ID`, `Nombre_Marca`, `Proveidor_Proveidor_ID`) VALUES (DEFAULT, 'Prett Glasses', 3);
...
START TRANSACTION;
USE `optica`;
INSERT INTO `optica`.`ulleres` (`Ulleres_id`, `Graduació_RH`, `Graduació_LH`, `Muntura`, `Color_Muntura`, `Color_vidre`, `Preu`, `Marcas_Marcas_ID`, `Marcas_Nombre_Marcas`) VALUES (DEFAULT, '2', '1', '2', 'blau', 'negre', 59, 1, '1');
INSERT INTO `optica`.`ulleres` (`Ulleres_id`, `Graduació_RH`, `Graduació_LH`, `Muntura`, `Color_Muntura`, `Color_vidre`, `Preu`, `Marcas_Marcas_ID`, `Marcas_Nombre_Marcas`) VALUES (DEFAULT, '1', '1', '2', 'verd', 'negre', 129, 3, '2');
INSERT INTO `optica`.`ulleres` (`Ulleres_id`, `Graduació_RH`, `Graduació_LH`, `Muntura`, `Color_Muntura`, `Color_vidre`, `Preu`, `Marcas_Marcas_ID`, `Marcas_Nombre_Marcas`) VALUES (DEFAULT, '3', '1', '3', 'verd', 'negre', 149, 3, '3');
